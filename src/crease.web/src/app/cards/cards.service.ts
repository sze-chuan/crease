...
export class CardsService {
        ...
        this.cardStatements = [
            {
                ...
                cardId: 1,
                cardTransactions: [
                    { id: 1, transactionDate: new Date(Date.now()), vendor: 'Lazada', amount: 10 }
                ],
    ...
    getCardStatement(cardId: number, statementPeriod: Date): Observable<CardStatement | undefined> {
        return of(this.cardStatements.find(x => x.cardId === cardId
