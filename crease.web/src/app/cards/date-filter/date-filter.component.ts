    ...
    template: `
        ...
        <div class="date-filter-group">
            <mat-form-field>
                ...
                <mat-select #monthSelect [value]="month" (selectionChange)="onMonthYearChanged(monthSelect.value, yearSelect.value)">
                    <mat-option
            ...
            <mat-form-field>
                ...
                <mat-select #yearSelect [value]="year" (selectionChange)="onMonthYearChanged(monthSelect.value, yearSelect.value)">
...
export class DateFilterComponent {
    ...
    constructor() {
        ...
        this.yearOptions = Array.from(new Array(this.maxNumberOfYears), (val, index) => index + this.startYear);
    }
